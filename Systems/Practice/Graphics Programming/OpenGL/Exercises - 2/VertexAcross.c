...
int main(int argc, char *args[])
{
    ...
    char vertexFilePath[] = "Exercises - 2/Shaders/Vert3.glsl",
         fragmentFilePath[] = "Exercises - 2/Shaders/Frag3.glsl";
    ...
    const char fragmentUniformName[] = "RenderColor",
               vertexUniformName[] = "horizontalOffset";

    int vertexOffset = glGetUniformLocation(shaders->shaderProgram, vertexUniformName), fragmentColor = glGetUniformLocation(shaders->shaderProgram, fragmentUniformName);
